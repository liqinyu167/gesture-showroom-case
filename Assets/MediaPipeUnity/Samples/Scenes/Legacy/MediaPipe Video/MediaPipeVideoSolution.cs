...
namespace Mediapipe.Unity.Sample.MediaPipeVideo
{
    ...
    {
        public System.Action<List<NormalizedLandmarkList>, List<ClassificationList>> OnHandLandmarksOutput;
        ...
        protected override IEnumerator Run()
        {
            ...
            while (true)
            {
                ...
                var imageFrame = result.Item1;
                var handLandmarks = result.Item2;
                var handedness = result.Item3;

                if (handLandmarks != null)
                {
                    OnHandLandmarksOutput?.Invoke(handLandmarks, handedness);
                }
